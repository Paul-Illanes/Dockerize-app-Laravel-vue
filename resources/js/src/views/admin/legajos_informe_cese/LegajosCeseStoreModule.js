...
export default {
  ...
  mutations: {},
  actions: {
    fetchLegajoCese(ctx, queryParams) {
        return new Promise((resolve, reject) => {
          
          if(!JSON.parse(sessionStorage.getItem('legajocese')) || queryParams.refreshStatus == 1){
            
            axios
              .get('/api/auth/legajo_cese/')
              .then(response => {
            ...
            const dato = JSON.parse(sessionStorage.getItem('legajocese'));
